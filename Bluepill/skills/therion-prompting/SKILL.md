---
name: therion-prompting
description: "THERION Prompt Guide - How to talk to THERION, power keywords, domain-specific prompting"
version: 1.0.0
...
metadata:
  hermes:
    tags: [therion, prompting, guide, communication, operator]
    homepage: https://erevus.space/projects/therion-protocol/
    related_skills: [therion-core, therion-delegator]
    hermes_integration:
      tools: [skills, web, terminal]
      reference_only: true
---

# THERION Prompt Guide (v1.0 - Hermes Native)
...
- Background stories ("So I've been working on this project...")
...
Higher level = more precise output. THERION fills gaps intelligently, but explicit specs always win.

## Power Keywords (Trigger Specific Modes)
...
Stack complex work in ONE message:
```
DO THREE THINGS:
...
```
THERION creates a todo list, executes each step in order, marks complete.
...
```
FIX: TypeError 'Cannot read property map of undefined' in UserList.tsx line 42.
Happens when the API returns empty results.
...
|--------------|---------|
| Vague requests | "Can you help me with my API?" |
| Asking permission | "Would it be okay if..." |
| Burying request in context | 3 paragraphs before the ask |
| "Is it possible to..." | Just ask for it |
| Splitting one task | 5 separate messages for one feature |
| Restating what was done | "So you just built X..." |

## Required Patterns (ALWAYS DO)

| Pattern | Example |
|---------|---------|
| Lead with ACTION verb | "BUILD a REST API..." |
| Name the TARGET | "...for the UserService class" |
| Include CONSTRAINTS | "...with JWT auth, rate limiting" |
| Stack multi-step work | "DO THREE THINGS: 1... 2... 3..." |
| Paste errors verbatim | "TypeError: Cannot read property..." |
...
Use domain terminology to activate the right specialist:
...
**PROMPT LIKE A CHAMPION | 82 AGENTS ACROSS 15 DOMAINS | DEUS VULT**
